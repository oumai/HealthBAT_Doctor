...
//        self.layer.borderColor = BASE_COLOR.CGColor;
        ...
        [self.leftImageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(self.image.size.width);
        }];
...
- (UITextField *)rightTF {
    if (!_rightTF) {
        _rightTF = [UITextField textFieldWithfont:[UIFont systemFontOfSize:15] textColor:BASE_COLOR placeholder:self.placehold BorderStyle:UITextBorderStyleNone];
//        _rightTF.clearButtonMode = UITextFieldViewModeAlways;
    }
    return _rightTF;
}
/*
