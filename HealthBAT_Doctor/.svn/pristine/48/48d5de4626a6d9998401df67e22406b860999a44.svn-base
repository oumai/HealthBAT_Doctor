...
//网络
#define APP_DOMAIN_URL [[NSUserDefaults standardUserDefaults] valueForKey:@"AppDomainUrl"]//域名
...
#define BLUE_COLOR UIColorFromHEX(0x7bb8fe, 1)
//渐变色
...
//医生信息
#define DoctorDetail_INFO [NSKeyedUnarchiver unarchiveObjectWithFile: [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/DoctorDetail.data"]]
...
#define BAT_LINE_COLOR UIColorFromHEX(0xeeeeee, 1)
#define BAT_TEXT_LIGHT_COLOR UIColorFromHEX(0x999999, 1)
#define BAT_TEXT_MIDDLE_COLOR UIColorFromHEX(0x666666, 1)
#define BAT_TEXT_DARK_COLOR UIColorFromHEX(0x333333, 1)
