...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(newsTableScrollToTop) name:@"Cell_LOCK_SCROLL" object:nil];
        ...
        self.leftTab.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 40 -64);
        
        [self.backScroView addSubview:self.rightTab];

        self.rightTab.frame = CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 40 -64);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == self.leftTab) {
        BATTopicTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:leftCellReuse forIndexPath:indexPath];
    ...
    BATTopicTableViewCell *cells = [tableView dequeueReusableCellWithIdentifier:RightCellReuse forIndexPath:indexPath];
...
- (UIScrollView *)backScroView {
    ...
    if (!_backScroView) {
        ...
        _backScroView.backgroundColor = [UIColor orangeColor];
