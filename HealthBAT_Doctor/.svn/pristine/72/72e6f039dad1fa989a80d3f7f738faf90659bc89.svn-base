...
//    [[NSUserDefaults standardUserDefaults] setValue:@"http://10.2.21.59:8081" forKey:@"searchdominUrl"];//陈珊
    [[NSUserDefaults standardUserDefaults] setValue:@"http://test.search.jkbat.com" forKey:@"searchdominUrl"];
    ...
    [[NSUserDefaults standardUserDefaults] setValue:@"http://hc001tn-h5.chinacloudsites.cn" forKey:@"AppDomainUrl"];
