...
- (void)viewDidLoad {
    ...
    [self.navigationItem.rightBarButtonItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:UIColorFromHEX(0x333333, 1),NSForegroundColorAttributeName, nil] forState:UIControlStateNormal];
