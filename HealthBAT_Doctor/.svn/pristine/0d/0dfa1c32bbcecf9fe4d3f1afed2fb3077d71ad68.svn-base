...
- (void)awakeFromNib {
    ...
    [self.rerecordingBtn setTitleColor:STRING_DARK_COLOR forState:UIControlStateNormal];
    self.rerecordingBtn.titleLabel.font = [UIFont systemFontOfSize:17];
    
    self.countingLb.textColor = BLUE_COLOR;
    ...
    self.recordType.textColor = STRING_MID_COLOR;
