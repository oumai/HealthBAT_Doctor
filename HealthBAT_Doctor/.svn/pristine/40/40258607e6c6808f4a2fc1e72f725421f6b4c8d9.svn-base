...
- (void)placeSubviews
{
    ...
    if (self.lastUpdatedTimeLabel.hidden) {
        ...
        self.lastUpdatedTimeLabel.hidden = YES;//产品说不要刷新时间
        // 更新时间
        if (self.lastUpdatedTimeLabel.constraints.count == 0) {
            //            self.lastUpdatedTimeLabel.mj_x = 50;
            self.lastUpdatedTimeLabel.mj_x = (self.frame.size.width - 200)/2.0 + 50;
            self.lastUpdatedTimeLabel.mj_y = stateLabelH;
            //            self.lastUpdatedTimeLabel.mj_w = self.mj_w;
            self.lastUpdatedTimeLabel.mj_w = 150;
            self.lastUpdatedTimeLabel.mj_h = self.mj_h - self.lastUpdatedTimeLabel.mj_y;
            //            self.lastUpdatedTimeLabel.backgroundColor = [UIColor greenColor];
        }
    }
