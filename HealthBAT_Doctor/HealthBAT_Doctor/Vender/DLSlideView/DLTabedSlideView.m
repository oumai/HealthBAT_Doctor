...
- (void)commonInit{
    ...
    [tabbar_ setBottomBorderWithColor:UIColorFromHEX(0xeeeeee, 1) width:SCREEN_WIDTH height:0.5];
...
- (void)buildTabbar{
    ...
    if (_tabbarBottomWidth > 0) {
        tabbar_.bottomLineSpaceX = (SCREEN_WIDTH/tabbar_.tabbarItems.count-_tabbarBottomWidth)/2.0;
    }
    
    if (_tabbarBottomLineSpaceX > 0) {
        tabbar_.bottomLineSpaceX = _tabbarBottomLineSpaceX;
    }
}
