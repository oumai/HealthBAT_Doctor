...
- (BATCustomButton *)priseBtn {
    ...
    if (!_priseBtn) {
        ...
        [_priseBtn setBackgroundImage:[UIImage imageNamed:@"ic-dz"] forState:UIControlStateNormal];
        [_priseBtn setBackgroundImage:[UIImage imageNamed:@"ic-dz-ss"] forState:UIControlStateSelected];
