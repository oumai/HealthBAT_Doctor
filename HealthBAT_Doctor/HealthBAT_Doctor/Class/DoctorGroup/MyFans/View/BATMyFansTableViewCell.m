...
- (void)configrationEachAttendCell:(id)model
{
    ...
    if ([myFansData.PhotoPath hasPrefix:@"http://"]) {
        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:myFansData.PhotoPath] placeholderImage:[UIImage imageNamed:@"personalCenter_defaultAvator"]];
    } else {
        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",APP_DOMAIN_URL,myFansData.PhotoPath]] placeholderImage:[UIImage imageNamed:@"personalCenter_defaultAvator"]];
    }
...
- (void)configrationCell:(id)model
{
    ...
    if ([myFansData.TopicImage hasPrefix:@"http://"]) {
        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:myFansData.TopicImage] placeholderImage:[UIImage imageNamed:@"personalCenter_defaultAvator"]];
    } else {
        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",APP_DOMAIN_URL,myFansData.TopicImage]] placeholderImage:[UIImage imageNamed:@"personalCenter_defaultAvator"]];
    }
