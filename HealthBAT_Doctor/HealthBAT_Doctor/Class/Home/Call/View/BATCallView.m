...
- (BATCallOptButton *)cancelButton
{
    if (_cancelButton == nil) {
        ...
        _cancelButton.imageView.image = [UIImage imageNamed:@"ic-qx"];
    }
...
- (BATCallOptButton *)hangUpButton
{
    if (_hangUpButton == nil) {
        ...
        _hangUpButton.imageView.image = [UIImage imageNamed:@"ic-qx"];
    }
...
- (BATCallOptButton *)answerButton
{
    if (_answerButton == nil) {
        ...
        _answerButton.imageView.image = [UIImage imageNamed:@"ic-jt"];
    }
